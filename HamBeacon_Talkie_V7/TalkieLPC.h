...
#else
// original values from TI5220 with 10 bit resolution
static const uint8_t tmsEnergy[0x10] PROGMEM = {0, 1, 2, 3, 4, 6, 8, 11, 16, 23, 33, 47, 63, 85, 114, 0};
...
static int8_t chirp[] = { 0x00, 0x03, 0x0f, 0x28, 0x4c, 0x6c, 0x71, 0x50, 0x25, 0x26, 0x4c, 0x44, 0x1a, 0x32, 0x3b, 0x13, 0x37,
        0x1a, 0x25, 0x1f, 0x1d };
#define CHIRP_SIZE sizeof(chirp) // is padded with zeros by software below
